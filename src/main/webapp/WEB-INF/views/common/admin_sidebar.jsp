...
<div class="container">
            ...
            <div class="menu">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li id="all_room_button">
                                <a href="#">
                                    <span class="text">All Room</span>
                                </a>
                            </li>
    ...
    <div class="contents">
        ...
        <div id="all_room" class="sub-contents">
            <jsp:include page="../room/allRoom.jsp" />
        </div>

        <div id="update_room" class="sub-contents">
            <jsp:include page="../room/addRoom.jsp" />
        </div>
