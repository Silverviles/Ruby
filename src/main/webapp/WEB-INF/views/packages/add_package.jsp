...
<div class="formContainer">
    ...
    <div class="form">
        ...
        <div class="ticket-form">
            ...
            <form action="${pageContext.request.contextPath}/packages/updatePackage" autocomplete="off">
                ...
                <div class="input-container">
                    <input type="number" id="packagePrice" name="packagePrice" class="input" step="0.01" min="0"
                           required/>
                ...
                <div class="input-container">
                    <input type="date" id="packageDiscontinueDate" name="packageDiscontinueDate" class="input"
                           required/>
