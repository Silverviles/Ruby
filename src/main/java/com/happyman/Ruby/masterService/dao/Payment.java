...
public class Payment {
	@Id @GeneratedValue(strategy = GenerationType.IDENTITY) @Column(name = "bID", nullable = false) private Integer id;
	...
	@Column(name = "amount", nullable = false) private Double billAmount;
